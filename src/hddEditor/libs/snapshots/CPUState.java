 ...
 * 
 * Note PC, is generally 0 for when its not provided, EG SNA files. In this
 * case, when generating a file, you should replace any final JP with a RET.
 */
