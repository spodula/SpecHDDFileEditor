...
public class AddFilesToTZXPartition  extends GenericAddPageDialog {
	 ...
	 * Current disk.
	 */
	private TZXPartition CurrentPartition = null;
	 ...
	 * @param p3d
	 */
	public void Show(String title, TZXPartition smp) {
	...
	protected String UniqueifyName(String s) {
		 ...
		 */
		for (TzxDirectoryEntry d : CurrentPartition.DirectoryEntries ) {
