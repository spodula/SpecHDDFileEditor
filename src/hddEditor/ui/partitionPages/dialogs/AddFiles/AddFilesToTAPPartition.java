...
public class AddFilesToTAPPartition extends GenericAddPageDialog {
	 ...
	 * @param display
	 */
	public AddFilesToTAPPartition(Display display, FileSelectDialog fsd, Languages lang) {
	...
	protected void DoAddFiles() {
		...
		for (TableItem file : files) {
			...
			try {
				...
				System.out.println(String.format(lang.Msg(Languages.MSG_ERRORADDING), details.OriginalFilename, details.filename)
				+ " " + e.getMessage());
